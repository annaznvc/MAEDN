...
import de.htwg.se.MAEDN.model.{Board, Field, FieldType, Player, Figure, IState, State}
  ...
  "TextDisplay" should {
   ...
   "print cover for Config state" in {
    val dummy = new de.htwg.se.MAEDN.model.Manager {
        ...
        override val board = de.htwg.se.MAEDN.model.Board(Vector.empty, Vector.empty)
