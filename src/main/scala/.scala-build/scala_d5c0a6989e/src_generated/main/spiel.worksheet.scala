...
final class spiel$u002Eworksheet$_ {
def args = spiel$u002Eworksheet_sc.args$
def scriptPath = """spiel.worksheet.sc"""
/*<script>*/
//Farben
enum Color:
...
object spiel$u002Eworksheet_sc {
  ...
  lazy val script = new spiel$u002Eworksheet$_
...
export spiel$u002Eworksheet_sc.script as `spiel.worksheet`
